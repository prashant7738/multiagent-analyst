...
\begin{frame}{Mid-Progress Timeline}
    \begin{itemize}
        ...
        \item \textbf{Next:} complete output validation and connect statistics to evidence-backed insight generation.
        \item \textbf{Final phase:} report assembly, upload workflow, frontend presentation, broader datasets, and end-to-end evaluation.
    \end{itemize}
\end{frame}
...
\begin{frame}{Remaining Work}
    \begin{center}
        \begin{tabular}{p{0.32\textwidth} p{0.52\textwidth}}
            ...
            \hline
            Validation guardrail & Check statistics, charts, and evidence \\
            Insight generation & Produce traceable natural-language findings \\
            Report assembly & Combine outputs into a user-facing report \\
