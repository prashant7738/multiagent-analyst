...
\begin{frame}{Agent 1: Raw Structural Profiler}
    \begin{columns}[T]
        ...
        \begin{column}{0.42\textwidth}
            \centering
            \includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio]{src/images/agent1.1img.png}\\[4pt]
            \includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio]{src/images/agent1.2img.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Agent 2: Technical Inference \& Semantic Tagging}
    \begin{columns}[T]
        ...
        \begin{column}{0.42\textwidth}
            \centering
            \includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio]{src/images/agent2.1img.png}\\[4pt]
            \includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio]{src/images/agent2.2img.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Agent 3: Context-Aware Preprocessing}
    \begin{columns}[T]
        ...
        \begin{column}{0.42\textwidth}
            \centering
            \includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio]{src/images/agent3.1img.png}\\[4pt]
            \includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio]{src/images/agent3.2img.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Agent 4: Visualization \& Statistical Analysis}
    \begin{columns}[T]
        ...
        \begin{column}{0.42\textwidth}
            \centering
            \includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio]{src/images/agent4.1img.png}\\[4pt]
            \includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio]{src/images/agent4.2img.png}
        \end{column}
    \end{columns}
\end{frame}
