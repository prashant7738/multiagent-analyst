...
export const GlowBorderCard = React.forwardRef((
    ...
    return (
        <div
            ref={ref}
            className={cn(// Base Container Layout
            "relative overflow-hidden grid place-content-center isolate", // Glass Effect Background
            "bg-zinc-50/50 dark:bg-neutral-900/60 backdrop-blur-md", // Custom className support
            className)}
            style={{
                width: width,
                height: height || 'auto',
